...
// Try to keep as small and local scope as possible, if a class, enum, struct or similar is only to be used in a .cc file, then it can be declared there, otherwise have it in the .h file.
...
// If a.cc needs something from other_header_needed.h and a.cc includes it, then it should still be included in this file (a.h), always include in both .h and .cc file. This goes for all inclusions. What this means is that you should not rely on transistive inclusions.
...
// Related .h file, related maybe because we are for example implementing or testing the stuff from some_file.h.
